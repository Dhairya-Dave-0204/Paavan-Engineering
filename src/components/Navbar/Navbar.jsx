...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="px-6 mx-auto max-w-7xl lg:px-10">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex">
              <Link
                to="/contact"
                className="px-5 py-2 text-white transition-all duration-300 font-body bg-primary hover:opacity-70"
              >
                Get Quote
              </Link>
            </div>
      ...
      {/* ================= MOBILE MENU ================= */}
      <div
        className={`fixed top-0 right-0 h-full w-3/4 max-w-sm bg-background shadow-lg transform transition-transform duration-300 z-[60] ${
